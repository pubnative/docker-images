...
export DRUID_PROPERTIES_FILE=/opt/druid/conf/druid/_common/common.runtime.properties
...
echo java -server -Duser.timezone=UTC -Dfile.encoding=UTF-8 $DRUID_JAVA_OPTIONS -cp "/opt/druid/conf/druid/_common:/opt/druid/lib/*${DRUID_EXTRA_CLASSPATH}" io.druid.cli.Main server $NODE_TYPE
exec java -server -Duser.timezone=UTC -Dfile.encoding=UTF-8 $DRUID_JAVA_OPTIONS -cp "/opt/druid/conf/druid/_common:/opt/druid/lib/*${DRUID_EXTRA_CLASSPATH}" io.druid.cli.Main server $NODE_TYPE
